...
public class Game2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView opinion0 = findViewById(R.id.textViewOpinion01);
        TextView opinion1 = findViewById(R.id.textViewOpinion11);
        TextView opinion2 = findViewById(R.id.textViewOpinion21);
        TextView opinion3 = findViewById(R.id.textViewOpinion31);
        ...
        CountDownTimer timer = new CountDownTimer(20000,1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(Game2.this, ScoreActivity.class);
